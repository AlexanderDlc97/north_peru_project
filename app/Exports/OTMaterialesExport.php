...
class OTMaterialesExport implements FromView, WithDrawings,WithColumnWidths, WithCustomStartCell, WithTitle
{
    // /**
    ...
    public function view(): View
    {
        ...
        $admin_ot = Otrabajo::whereBetween('created_at', [$this->inicio,$this->fin])->get();
        return view('ADMINISTRADOR.REPORTES.seguimiento-ot.xlsx.materiales-orden-trabajos', compact('admin_ot', 'desde', 'hasta', 'fecha_actual'));
    }

    public function title(): string
    {
    	return 'MATERIALES OT';
    }
