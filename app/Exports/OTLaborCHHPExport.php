...
class OTLaborCHHPExport implements FromView, WithDrawings,WithColumnWidths, WithCustomStartCell, WithTitle
{
    // /**
    ...
    public function view(): View
    {
        ...
        return view('ADMINISTRADOR.REPORTES.seguimiento-ot.xlsx.labor_chhp', compact('horas_operarios', 'desde', 'hasta', 'fecha_actual'));
    }


    public function title(): string
    {
    	return 'LABORES POR CUENTAS';
    }
