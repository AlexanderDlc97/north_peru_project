...
class OTHorasOpExport implements FromView, WithDrawings,WithColumnWidths, WithCustomStartCell, WithTitle
{
    // /**
    ...
    public function view(): View
    {
        ...
        $horas_operarios = Operacionespolifuncional::whereBetween('created_at', [$this->inicio,$this->fin])->get();
        return view('ADMINISTRADOR.REPORTES.seguimiento-ot.xlsx.horas-orden-trabajos', compact('horas_operarios', 'desde', 'hasta', 'fecha_actual'));
    }


    public function title(): string
    {
    	return 'HORAS OPERARIOS OT';
    }
