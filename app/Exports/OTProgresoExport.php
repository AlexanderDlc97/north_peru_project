...
class OTProgresoExport implements FromView, WithDrawings,WithColumnWidths, WithCustomStartCell, WithTitle
{
    // /**
    ...
    public function view(): View
    {
        ...
        $admin_ot_seguimientos = Detalleprogreso::whereBetween('fecha', [$this->inicio,$this->fin])->orderBy('fecha', 'Asc')->get();
        return view('ADMINISTRADOR.REPORTES.seguimiento-ot.xlsx.progreso-orden-trabajos', compact('admin_ot_seguimientos', 'desde', 'hasta', 'fecha_actual'));
    }

    public function title(): string
    {
    	return 'SEGUIMIENTO OT';
    }
