...
<div class="modal fade" id="edit_marca{{$admin_marca->slug}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="card border-0 rounded-0 border-start border-3 border-info mb-4" style="box-shadow: rgba(17, 17, 26, 0.1) 0px 1px 0px; background-color: #f6f6f6">
                    ...
                    <div class="">
                        <div class="mb-2">
                            ...
                            <input name="name" value="{{$admin_marca->name}}" id="marca_id" type="text" class="form-control" required>
                            @error('name')
