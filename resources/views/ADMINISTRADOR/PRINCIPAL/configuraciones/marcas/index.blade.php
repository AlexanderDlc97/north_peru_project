                ...
                <div class="card-header bg-transparent">
                    <div class="row justify-content-between">
                        <div class="col-12 col-md-3 col-xl-2 d-flex">
                            <button type="button" data-bs-toggle="modal" data-bs-target="#createmarcas" class="btn btn-primary btn-sm text-uppercase text-white w-100" style="border-radius: 20px">
                                        ...
                                        <div class="text-start text-md-center">
                                            <div class="dropstart">
                                                ...
                                                <ul class="dropdown-menu">                                                
                                                    ...
                                                    <button class="bg-transparent border-0 px-0 mx-0" data-bs-toggle="modal" data-id="{{$admin_marca->slug}}" id="edit_button" data-bs-target="#edit_marca{{$admin_marca->slug}}"><i class="bi bi-pencil-square me-2"></i>Editar</button>
                                                    </li>  
                                                    <li class="dropdown-item">
